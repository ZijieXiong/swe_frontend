...
export default function About({customerReview}) {
    ...
    useEffect(() => {
        ...
        const handleSubmit = (e) => {
            ...
            axios.post(`https://swe-temp.herokuapp.com/review_list/${leaveReview}`, userObject)
    ...
    return(
        ...
        <div id = "About_section">
            ...
            <p className="about-text">The idea was born with the interests of 5 intellectual students at NYU Tandon. <br/>We serve to provide the best quality food and service to our customers.</p>
            <div id="map-section">
            ...
            <div id="feedback-section">
                ...
                <div className="wrapper">
                    <form>
                       ...
                       onChange={e => setLeaveReview(e.target.value)} required
                       
                       />
                        
                        
                        <button id="about_submit_button" onClick = {handleSubmit } type="submit">Submit</button>
